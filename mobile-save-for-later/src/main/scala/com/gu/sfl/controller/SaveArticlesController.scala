...
import com.gu.sfl.lib.{Base64Utils, CloudWatchPublisher}
...
class SaveArticlesController(updateSavedArticles: UpdateSavedArticles, cloudWatchPublisher: CloudWatchPublisher)(implicit executionContext: ExecutionContext) extends Function[LambdaRequest, Future[LambdaResponse]] with SaveForLaterController with Base64Utils {
